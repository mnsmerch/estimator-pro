                ...
                {activeOption.otherEntries.map(entry => (
                  <div key={entry.id} className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-16 shrink-0 px-2 py-2 border border-gray-300 rounded-lg text-sm text-center focus:outline-none focus:ring-2 focus:ring-brand-500"
                    />
                    <input
                      type="number" step="0.1" min="0" placeholder="gal"
                      value={entry.gallons}
          ...
          <div className="w-full lg:w-56 lg:shrink-0 lg:sticky lg:top-24 space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="divide-y divide-gray-50">
                ...
                {ceilingCalc.hours > 0 && (
                  <div className="px-4 py-2">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1.5">Ceilings</p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">Hours</span>
                      <span className="text-sm font-semibold tabular-nums text-brand-700">
                        {ceilingCalc.hours.toFixed(2)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between mt-1">
                      <span className="text-xs text-gray-500">Gallons</span>
                ...
                {/* Other */}
                {(otherCalc.hours > 0 || otherCalc.gallons > 0) && (
                  <div className="px-4 py-2">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1.5">Other</p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">Hours</span>
                      <span className="text-sm font-semibold tabular-nums text-brand-700">
                        {otherCalc.hours.toFixed(2)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between mt-1">
                      <span className="text-xs text-gray-500">Gallons</span>
                    ...
                    <div className="flex items-center justify-between mt-1">
                      <span className="text-xs text-gray-500">Labor</span>
                      <span className="text-sm font-semibold tabular-nums text-brand-700">
                        ${otherCalc.laborCost.toFixed(2)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between mt-1">
                      <span className="text-xs text-gray-500">Price</span>
                      <span className="text-sm font-semibold tabular-nums text-green-700">
                        ${otherCalc.price.toFixed(2)}
                      </span>
                    </div>
                  </div>
                )}
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="divide-y divide-gray-50 text-xs pb-2">
                {([
                  ...
                  ['Other Gallons',     painterOverview.otherGallons,   false],
        ...
        {entries.map(entry => (
          <div key={entry.id} className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-20 shrink-0 px-2 py-2 border border-gray-300 rounded-lg text-sm text-center focus:outline-none focus:ring-2 focus:ring-brand-500"
            />
            <button
        ...
        {measurements.map(m => (
          <div key={m.id} className="flex items-center gap-2">
            <input type="number" step="0.1" min="0" placeholder="0" value={m.value} onChange={e => onPatchRow(m.id, e.target.value)}
              className="w-28 px-3 py-2 border border-gray-300 rounded-lg text-sm text-center focus:outline-none focus:ring-2 focus:ring-brand-500" />
