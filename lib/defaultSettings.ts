...
export const DEFAULT_INTERIOR_RATES: InteriorProductionRates = {
  ...
  wallTypes: {
    ...
    primeNewTexturedDrywall: { sqftPerHr: 95.78313253, handCut: 40 },
    primeNewSmoothDrywall:   { sqftPerHr: 76.36363636, handCut: 40 },
  ...
  ceilingTypes: {
    ...
    primeNewTexturedVaulted:      33.33333333,
    primeNewSmooth:               33.33333333,
  ...
  doorTypes: {
    ...
    commercialSteel1Side:        { hours: 1.375,        lnft: 55  },
    ...
    sameColorCSSteel1Side:       { hours: 1.03125,      lnft: 55  },
    sameColorCSSteelBothSides:   { hours: 2.0625,       lnft: 110 },
  ...
  doorFrameTypes: {
    ...
    dfCloset1Side:                { hours: 0.5882352941, lnft: 20  },
    dfClosetBothSides:            { hours: 1.176470588,  lnft: 40  },
    dfDoorSameColor1Side:         { hours: 0.375,        lnft: 17  },
    dfDoorSameColorBothSides:     { hours: 0.75, lnft: 34  },
    dfSameColorCloset1Side:       { hours: 0.4411764706, lnft: 20  },
    dfSameColorClosetBothSides:   { hours: 0.8823529412, lnft: 40  },
    ...
    dfStainToPaintCloset1Side:    { hours: 1.470588235,  lnft: 20  },
    dfStainToPaintClosetBothSides:{ hours: 2.941176471,  lnft: 40  },
  ...
  windowTypes: {
    ...
    vinylSillTrim:        { hours: 0.1666666667, lnft: 4  },
    ...
    scVinylNoTrim:        { hours: 0.09375,      lnft: 0  },
    scVinylSillTrim:      { hours: 0.125,        lnft: 4  },
    scVinylTrim4Sides:    { hours: 0.75,  lnft: 16 },
    scWoodNoTrim:         { hours: 0.1875,       lnft: 0  },
    scWoodDontOpen:       { hours: 0.9375,       lnft: 16 },
    scWoodOpens:          { hours: 1.3125,       lnft: 20 },
    scTwoToneDontOpen:    { hours: 1.3125,       lnft: 32 },
    scTwoToneOpens:       { hours: 1.6875,       lnft: 36 },
    stpVinylSillTrim:     { hours: 0.4166666667, lnft: 4  },
    stpVinylTrim4Sides:   { hours: 2.5,   lnft: 16 },
    stpWoodNoTrim:        { hours: 0.625,        lnft: 0  },
    stpWoodDontOpen:      { hours: 3.125,        lnft: 16 },
    stpWoodOpens:         { hours: 4.375,        lnft: 20 },
    stpTwoToneDontOpen:   { hours: 4.375,        lnft: 32 },
    stpTwoToneOpens:      { hours: 5.625,        lnft: 36 },
